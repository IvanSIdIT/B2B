...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/api/ai/chat' | '/api/ai/test-prompt' | '/api/auth/login' | '/api/auth/logout' | '/manager' | '/worker'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/api/ai/chat' | '/api/ai/test-prompt' | '/api/auth/login' | '/api/auth/logout' | '/manager' | '/worker'
  id: '__root__' | '/' | '/api/ai/chat' | '/api/ai/test-prompt' | '/api/auth/login' | '/api/auth/logout' | '/manager' | '/worker'
